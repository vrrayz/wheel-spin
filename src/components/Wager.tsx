...
export const Wager = ({ stakeAndSpin, isButtonDisabled }: WagerProperties) => {
  ...
  return (
    <WagerSection>
      ...
      <WagerInput
        ...
        className={errorExist ? "error" : ""}
        value={amount}
        onChange={(e) => setAmount(Number(e.target.value))}
        disabled={isButtonDisabled}
      />
      <ButtonStakeContainer>
        <WagerButton onClick={verifyAndWager} disabled={isButtonDisabled}>
          Wager
        </WagerButton>
        <ApproveButton disabled>Approve</ApproveButton>
      </ButtonStakeContainer>
    </WagerSection>
  );
};
